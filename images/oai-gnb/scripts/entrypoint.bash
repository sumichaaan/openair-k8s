...
DEFAULT_MODE="GNB_BAND79"
MNC_LENGTH=${MNC_LENGTH:-${#MNC}}

# look up configuration template to use
MODE=${MODE:-${DEFAULT_MODE}}
case "${MODE^^}" in
    GNB_BAND79)	TEMPLATE=${CONFIG_DIR}/gnb.n79.conf.template;;
    CU_BAND79)  TEMPLATE=${CONFIG_DIR}/cu.n79.conf.template;;
    DU_BAND79)  TEMPLATE=${CONFIG_DIR}/du.n79.conf.template;;
